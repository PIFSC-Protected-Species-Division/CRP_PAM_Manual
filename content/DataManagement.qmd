...
**R-script compiled all the databases by sheet into CSV files and there is single Excel file containing all the data except the gps CSV.**
...
| Dwarf sperm whale             | *Kogia sima*                 | 048           | [Example]       |
