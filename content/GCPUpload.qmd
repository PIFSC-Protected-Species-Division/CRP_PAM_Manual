...
From my limited understanding this has to do with how trailing slashes are interpreted on Windows. Try to avoid it if you can. 


### Manually sync a folder (`rsync`) __*Preferred method*__
